...
from chia.full_node.custom_block_store import BlockStore
from chia.full_node.lock_queue import LockQueue, LockClient
from chia.full_node.bundle_tools import detect_potential_template_generator
from chia.full_node.custom_coin_store import CoinStore
...
class FullNode:
    ...
    async def _start(self):
        ...
        self.db_wrapper = DBWrapper(self.connection, self.pgdb_connection)
